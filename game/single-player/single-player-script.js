...
const Players = (mark, activity) => {
    ...
    const playGame = (player1, bot) => {
        ...
        function playBot() {
            ...
            let count = {};
            gameBoard.gamePlan.forEach(function(i) { count[i] = (count[i]||0) + 1;});
            ...
            if((gameBoard.gamePlan[4] !== "X" && count.X === 1) && (gameBoard.gamePlan[4] !== "O" && count.X === 1)) {
                ...
                currectCell = 2;
            } else if((gameBoard.gamePlan[5] === "X" && gameBoard.gamePlan[7] === "X") && (gameBoard.gamePlan[8] === "")) {
                currectCell = 8;
            } else if((gameBoard.gamePlan[3] === "X" && gameBoard.gamePlan[7] === "X") && (gameBoard.gamePlan[6] === "")) {
                currectCell = 6;
            ...
            if(playerOnePasive) {
                if(gameBoard.gamePlan[currectCell] !== "X" && gameBoard.gamePlan[currectCell] !== "O") {
                    gameBoard.getCell(currectCell, "O");
                    playerOnePasive = false;
                    gameBoard.checkForWin();
                } else if(gameBoard.gamePlan[currectCell] === "X" && gameBoard.gamePlan[currectCell] === "O") {
                    false;
                }
            }
        }
